    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-navy-500">
        <div className="text-center">
          ...
          <p className="text-text-secondary">{strings.dashboard.loadingStats}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-navy-500">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold text-text-primary mb-2">{strings.dashboard.unableToLoadData}</h2>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <StatsCard
            ...
            icon={<TrendingUp className="w-5 h-5" style={{ color: '#e8cb2b' }} />}
            iconColor="#e8cb2b"
            delay={0}
          />
          <StatsCard
            ...
            icon={<BarChart3 className="w-5 h-5" style={{ color: '#f7931a' }} />}
            iconColor="#f7931a"
            delay={50}
          />
          <StatsCard
            ...
            icon={<Coins className="w-5 h-5" style={{ color: '#4fadc2' }} />}
            iconColor="#4fadc2"
            delay={100}
          />
        </div>
        ...
        {(!stats || stats.monthly.length === 0) && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-text-primary mb-2">{strings.dashboard.noDataYet}</h3>
