export const translations = {
  en: {
    ...
    login: {
      ...
      securityNote: '🔒 Your credentials are stored locally and never leave your browser.',
      errorBothRequired: 'Please enter both API Key and API Secret',
      errorInvalidCredentials: 'Invalid credentials. Please check your API Key and Secret.',
    },
    dashboard: {
      title: 'Partner Dashboard',
      loadingStats: 'Loading your stats...',
      unableToLoadData: 'Unable to Load Data',
      errorLoadingStats: 'Failed to load stats. Please check your credentials and try again.',
      ...
      noDataDescription: 'Once your referral link starts generating swaps, your stats will appear here.',
    },
    table: {
